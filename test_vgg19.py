...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run inference with VGG19 on sample images.")
    parser.add_argument("--weights", default="log-vgg19/vgg19.h5", help="Path to trained weights.")
